...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Yo(e,t,n){let r=new Float32Array(Fo),i=new q(0,1,0);return new Ca({name:`SphericalGaussianBlur`,defines:{n:Fo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Qo(),fragmentShader:`
	...
	`}var $o=class extends Pt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ni(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var wc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Tc(e,t){let n=wc[t];return n===void 0?(H(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Ec=new q;function Dc(){return Y.getLuminanceCoefficients(Ec),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Ec.x.toFixed(4)}, ${Ec.y.toFixed(4)}, ${Ec.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),r=new ri(new hr,t);r.visible=!1,e.add(r),n.push({mesh:r,mat:t,active:!1,start:0,dur:2.1})}return{fire(e,t,r,i,a=2.1,o=.13){let s=n.find(e=>!e.active);if(!s)return;let c=e.distanceTo(t),l=e.clone().add(t).multiplyScalar(.5);l.y=2+c*.26;let u=new ua(e,l,t);s.mesh.geometry.dispose(),s.mesh.geometry=new ma(u,26,o,6,!1),s.mat.uniforms.uColor.value.set(i),s.mat.uniforms.uDraw.value=0,s.mat.uniforms.uFade.value=1,s.active=!0,s.start=r,s.dur=a,s.mesh.visible=!0},update(e){n.forEach(t=>{if(!t.active)return;let n=e-t.start;if(n>=t.dur){t.active=!1,t.mesh.visible=!1;return}t.mat.uniforms.uDraw.value=Math.min(n/.5,1),t.mat.uniforms.uHead.value=n/.7%1,t.mat.uniforms.uFade.value=n<t.dur-.6?1:(t.dur-n)/.6})},dispose(){n.forEach(e=>{e.mesh.geometry.dispose(),e.mat.dispose()})}}}function au(e){let t=[];function n(t){e.remove(t.sprite),t.sprite.material.map.dispose(),t.sprite.material.dispose()}return{spawn(n,r,i,a,o,s=.12){n.position.set(r.x,i,r.z),t.push({sprite:n,born:a,ttl:o,rise:s,baseY:i,baseScaleX:n.scale.x,baseScaleY:n.scale.y}),e.add(n)},update(e){for(let r=t.length-1;r>=0;r--){let i=t[r],a=e-i.born;if(a>=i.ttl){n(i),t.splice(r,1);continue}let o=Xl(Math.min(a/.45,1));i.sprite.scale.set(i.baseScaleX*o,i.baseScaleY*o,1);let s=Math.min(a/.3,1),c=a>i.ttl-.55?(i.ttl-a)/.55:1;i.sprite.material.opacity=s*c,i.sprite.position.y=i.baseY+Math.sin(e*1.6+i.born)*.22+a*i.rise}},dispose(){t.forEach(n),t.length=0}}}function ou(e,t=2){let n=[];for(let r=0;r<t;r++){let t=new hr;t.setAttribute(`position`,new er(new Float32Array(138),3));let r=new Ei({size:.42,color:1226602,transparent:!0,opacity:0,depthWrite:!1,sizeAttenuation:!0}),i=new ji(t,r);i.visible=!1,e.add(i),n.push({pts:i,geo:t,mat:r,vels:new Float32Array(138),origin:new q,active:!1,start:0})}return{fire(e,t){let r=n.find(e=>!e.active);if(r){r.origin.copy(e);for(let e=0;e<46;e++){let t=Math.random()*Math.PI*2,n=4+Math.random()*7,i=2+Math.random()*5;r.vels[e*3]=Math.cos(t)*i,r.vels[e*3+1]=n,r.vels[e*3+2]=Math.sin(t)*i}r.active=!0,r.start=t,r.pts.visible=!0}},update(e){n.forEach(t=>{if(!t.active)return;let n=e-t.start;if(n>1.3){t.active=!1,t.pts.visible=!1;return}let r=t.geo.attributes.position.array;for(let e=0;e<46;e++)r[e*3]=t.origin.x+t.vels[e*3]*n,r[e*3+1]=t.origin.y+t.vels[e*3+1]*n-9.5*n*n,r[e*3+2]=t.origin.z+t.vels[e*3+2]*n;t.geo.attributes.position.needsUpdate=!0,t.mat.opacity=n<.15?n/.15:1-(n-.15)/1.15})},dispose(){n.forEach(e=>{e.geo.dispose(),e.mat.dispose()})}}}function su(e,{reducedMotion:t,onReply:n}){let r=new xn;r.fog=new bn(16513784,95,215);let i=new Xa(36,1,.1,500),a=new q(0,12,-6),o=new q(0,42,88),s=new q(0,95,170),c=a.clone(),l=a.clone(),u=o.clone(),d=o.clone();i.position.copy(t?o:s);let f=new Ll({antialias:!0,alpha:!0});f.setPixelRatio(Math.min(window.devicePixelRatio,1.75)),f.setClearColor(0,0),e.appendChild(f.domElement);let p=[];for(let e=-125;e<=-66.5;e+=.72)for(let t=24.5;t<=49.4;t+=.58)Jl(e,t,Rl)&&p.push({lon:e,lat:t});let m=p.length+Bl.length,h=new Float32Array(m*3),g=new Float32Array(m),_=new Float32Array(m),v=new Float32Array(m),y=new Float32Array(m);p.forEach((e,t)=>{let{x:n,z:r}=ql(e.lon,e.lat);h.set([n,0,r],t*3),g[t]=1.55,_[t]=0}),Bl.forEach((e,t)=>{let n=p.length+t,{x:r,z:i}=ql(e.lon,e.lat);h.set([r,.4,i],n*3),g[n]=5,_[n]=1});let b=new hr;b.setAttribute(`position`,new er(h,3)),b.setAttribute(`aSize`,new er(g,1)),b.setAttribute(`aKind`,new er(_,1)),b.setAttribute(`aFlare`,new er(v,1)),b.setAttribute(`aHotSel`,new er(y,1));let x=new Ca({transparent:!0,depthWrite:!1,uniforms:{uTime:{value:0}},vertexShader:`
    ...
    `});r.add(new ji(b,x));let S=Rl.map(([e,t])=>{let{x:n,z:r}=ql(e,t);return new q(n,.05,r)}),C=new Ti(new hr().setFromPoints(S),new hi({color:13223098,transparent:!0,opacity:.8}));r.add(C);let w=Vl.map(e=>{let{x:t,z:n}=ql(e.lon,e.lat),i=nu(e.name);return i.position.set(t,1.6,n),r.add(i),i}),T=ru(r,10),E=iu(r,14),D=au(r),ee=Bl.map((e,t)=>{let{x:n,z:r}=ql(e.lon,e.lat);return{idx:p.length+t,city:e,vec:new q(n,.4,r)}}),O=t?1/0:2.6,k=0,A=[];function j(e,t,r,i){let a=t||Zl(ee),s=r||Hl[k%Hl.length];k++,l.set(a.vec.x*.62,9,a.vec.z*.5-4),d.set(o.x+a.vec.x*.34,o.y-7,o.z-10),v[a.idx]=1,y[a.idx]=0,T.fire(a.vec,e,Gl,1),D.spawn($l(a.city.name,s),a.vec,7.4,e,i?12:6);let c=ee.filter(e=>{let t=e.vec.distanceTo(a.vec);return t>.5&&t<24}).sort(()=>Math.random()-.5).slice(0,6);c.forEach((t,n)=>{A.push({at:e+.55+n*.16,fn:e=>{E.fire(a.vec.clone(),t.vec.clone(),e,Gl,1.9),v[t.idx]=.55,y[t.idx]=0}})}),!i&&c.slice(0,2+Math.floor(Math.random()*2)).forEach((t,r)=>{let i=Zl(Ul),o=Zl(Wl);A.push({at:e+2+r*.55,fn:e=>{v[t.idx]=1,y[t.idx]=1,T.fire(t.vec,e,Kl,.45),E.fire(t.vec.clone(),a.vec.clone(),e,Kl,2.2),D.spawn(eu(t.city.name,i,o),t.vec,4.6,e,3.6),n?.(o)}})})}let M=new go,te=new ui(new q(0,1,0),0),ne=new q;function N(t){let n=e.getBoundingClientRect(),r=(t.clientX-n.left)/n.width*2-1,a=-((t.clientY-n.top)/n.height)*2+1;if(M.setFromCamera({x:r,y:a},i),!M.ray.intersectPlane(te,ne))return;let o=null,s=1/0;if(ee.forEach(e=>{let t=e.vec.distanceTo(ne);t<s&&(s=t,o=e)}),o&&s<14){let e=re.getElapsedTime();j(e,o),O=e+9}}e.addEventListener(`pointerdown`,N);let re=new yo,ie=0,ae=0,oe=0,P=!0,se=!1;function ce(e){ie=(e.clientX/window.innerWidth-.5)*2,ae=(e.clientY/window.innerHeight-.5)*2}window.addEventListener(`pointermove`,ce,{passive:!0});function F(){if(oe=requestAnimationFrame(F),!P)return;let e=re.getElapsedTime();if(x.uniforms.uTime.value=e,!t){!se&&e>O&&(j(e),O=e+7.5);for(let t=A.length-1;t>=0;t--)e>=A[t].at&&(A[t].fn(e),A.splice(t,1));for(let e=0;e<m;e++)v[e]>.001?v[e]*=.975:v[e]=0;if(b.attributes.aFlare.needsUpdate=!0,b.attributes.aHotSel.needsUpdate=!0,T.update(e),E.update(e),D.update(e),e<2.2){let t=Yl(Math.min(e/2.2,1));i.position.lerpVectors(s,o,t),u.copy(i.position)}else u.lerp(d,.018),c.lerp(l,.022),i.position.set(u.x+Math.sin(e*.05)*1.6+ie*2.2,u.y+ae*-1.4,u.z+Math.cos(e*.04)*1)}i.lookAt(c),f.render(r,i)}function le(){let t=e.clientWidth,n=e.clientHeight;!t||!n||(i.aspect=t/n,i.updateProjectionMatrix(),f.setSize(t,n))}let ue=new ResizeObserver(le);ue.observe(e),le(),F();let de=new IntersectionObserver(([e])=>{P=e.isIntersecting},{threshold:.02});return de.observe(e),{dispose(){cancelAnimationFrame(oe),de.disconnect(),ue.disconnect(),window.removeEventListener(`pointermove`,ce),e.removeEventListener(`pointerdown`,N),b.dispose(),x.dispose(),C.geometry.dispose(),C.material.dispose(),T.dispose(),E.dispose(),D.dispose(),w.forEach(e=>{e.material.map.dispose(),e.material.dispose()}),f.dispose(),e.removeChild(f.domElement)},fireSellCall(){let e=re.getElapsedTime();j(e),O=e+12},fireSellCallWithData(e,t){let n=re.getElapsedTime();j(n,ee.find(t=>t.city.name===e)||null,t||null,!0),O=n+20},fireResponse(e,t,r,i){let a=re.getElapsedTime(),o=ee.find(t=>t.city.name===e),s=ee.find(e=>e.city.name===t);!o||!s||(v[s.idx]=1,y[s.idx]=1,T.fire(s.vec,a,Kl,.45),E.fire(s.vec.clone(),o.vec.clone(),a,Kl,2.2),D.spawn(eu(r,i,Zl(Wl)),s.vec,4.6,a,3.6),n?.(Zl(Wl)))},pauseAuto(){se=!0},resumeAuto(){se=!1,O=re.getElapsedTime()+4},get _autoPaused(){return se}}}var cu=[`Tucson`,`Flagstaff`,`Yuma`,`Prescott`,`San Diego`,`Riverside`,`El Paso`,`Las Vegas`];function lu(e){let t=new xn;t.fog=new bn(16513784,42,90);let n=new Xa(40,1,.1,200);n.position.set(0,24,28);let r=new Ll({antialias:!0,alpha:!0});r.setPixelRatio(Math.min(window.devicePixelRatio,1.75)),r.setClearColor(0,0),e.appendChild(r.domElement);let i=[];for(let e=-18;e<=18;e+=1.3)for(let t=-18;t<=18;t+=1.3)Math.hypot(e,t)<=17&&i.push(e,0,t);let a=new hr;a.setAttribute(`position`,new er(new Float32Array(i),3));let o=new Ei({color:13486271,size:.16,transparent:!0,opacity:.8,sizeAttenuation:!0});t.add(new ji(a,o));let s=[6.5,13].map(e=>{let n=[];for(let t=0;t<=80;t++){let r=t/80*Math.PI*2;n.push(new q(Math.cos(r)*e,.02,Math.sin(r)*e))}let r=new Ci(new hr().setFromPoints(n),new hi({color:14538959,transparent:!0,opacity:.9}));return t.add(r),r}),c=new pa(.5,20,20),l={mesh:new ri(c,new Gr({color:Gl})),vec:new q(0,.5,0),flare:0};l.mesh.position.copy(l.vec),t.add(l.mesh);let u=nu(`YOUR YARD — PHOENIX`,{color:`#d92d20`,opacity:.95,scale:.034,font:`700 30px 'IBM Plex Mono', monospace`});u.position.set(0,2.1,0),t.add(u);let d=new X(4672599),f=new X(Kl),p=cu.map((e,n)=>{let r=n/cu.length*Math.PI*2-Math.PI/2+.18,i=11.5+n%2*2.6,a=new q(Math.cos(r)*i,.45,Math.sin(r)*i*.82),o=new ri(c,new Gr({color:d.clone()}));o.position.copy(a),o.scale.setScalar(.82),t.add(o);let s=nu(e.toUpperCase(),{color:`#6b6f7a`,opacity:.85,scale:.028});return s.position.set(a.x,1.8,a.z),t.add(s),{name:e,vec:a,mesh:o,label:s,flare:0,hot:0}}),m=ru(t,8),h=iu(t,10),g=au(t),_=ou(t,2),v=[],y=!1;function b(e,t={}){if(y)return;y=!0;let n=x.getElapsedTime();l.flare=1,m.fire(l.vec,n,Gl,.8),g.spawn($l(`Your yard`,e,.022),l.vec,5.6,n,5.4),p.forEach((e,t)=>{v.push({at:n+.45+t*.1,fn:t=>{h.fire(l.vec.clone(),e.vec.clone(),t,Gl,1.7,.09),e.flare=.6,e.hot=0}})});let r=[...p].sort(()=>Math.random()-.5).slice(0,2+Math.floor(Math.random()*2)),i=r.map(()=>Zl(Wl));r.forEach((e,t)=>{v.push({at:n+1.9+t*.55,fn:n=>{e.flare=1,e.hot=1,m.fire(e.vec,n,Kl,.4),h.fire(e.vec.clone(),l.vec.clone(),n,Kl,2,.09),g.spawn(eu(e.name,Zl(Ul),i[t],.02),e.vec,3.4,n,3.2)}})});let a=Math.min(...i);v.push({at:n+4.1,fn:e=>{g.spawn(tu(a),l.vec,6.4,e,2.6,.35),_.fire(new q(0,1.5,0),e),t.onSale?.(a,r.length)}}),v.push({at:n+6,fn:()=>{y=!1,t.onDone?.()}})}let x=new yo,S=0,C=!0;function w(){if(S=requestAnimationFrame(w),!C)return;let e=x.getElapsedTime();for(let t=v.length-1;t>=0;t--)e>=v[t].at&&(v[t].fn(e),v.splice(t,1));l.flare*=.97,l.mesh.scale.setScalar(1+l.flare*.7+Math.sin(e*2.4)*.05),p.forEach(e=>{e.flare*=.97,e.mesh.scale.setScalar(.82+e.flare*.6),e.mesh.material.color.copy(d).lerp(e.hot?f:new X(Gl),Math.min(e.flare,1))}),m.update(e),h.update(e),g.update(e),_.update(e),n.position.x=Math.sin(e*.12)*2.2,n.position.y=24+Math.sin(e*.09)*.8,n.lookAt(0,1.5,0),r.render(t,n)}function T(){let t=e.clientWidth,i=e.clientHeight;!t||!i||(n.aspect=t/i,n.updateProjectionMatrix(),r.setSize(t,i))}let E=new ResizeObserver(T);E.observe(e),T(),w();let D=new IntersectionObserver(([e])=>{C=e.isIntersecting},{threshold:.02});return D.observe(e),{run:b,dispose:()=>{cancelAnimationFrame(S),D.disconnect(),E.disconnect(),a.dispose(),o.dispose(),s.forEach(e=>{e.geometry.dispose(),e.material.dispose()}),c.dispose(),l.mesh.material.dispose(),u.material.map.dispose(),u.material.dispose(),p.forEach(e=>{e.mesh.material.dispose(),e.label.material.map.dispose(),e.label.material.dispose()}),m.dispose(),h.dispose(),g.dispose(),_.dispose(),r.dispose(),e.removeChild(r.domElement)}}}function uu(e){let t=new xn,n=new Xa(45,1,.1,100);n.position.set(0,7,20),n.lookAt(0,0,0);let r=new Ll({antialias:!0,alpha:!0});r.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),r.setClearColor(0,0),e.appendChild(r.domElement);let i=1440,a=new Float32Array(i*3),o=0;for(let e=0;e<90;e++)for(let t=0;t<16;t++)a[o++]=(e/89-.5)*56,a[o++]=0,a[o++]=(t/15-.5)*12;let s=new hr;s.setAttribute(`position`,new er(a,3));let c=new Ei({color:16740193,size:.13,transparent:!0,opacity:.55,blending:2,depthWrite:!1});t.add(new ji(s,c));let l=new yo,u=0,d=!0;function f(){if(u=requestAnimationFrame(f),!d)return;let e=l.getElapsedTime(),a=s.attributes.position.array;for(let t=0;t<i;t++){let n=a[t*3],r=a[t*3+2];a[t*3+1]=Math.sin(n*.32+e*1.1)*.9+Math.sin(n*.11-e*.6+r*.4)*.7}s.attributes.position.needsUpdate=!0,r.render(t,n)}function p(){let t=e.clientWidth,i=e.clientHeight;!t||!i||(n.aspect=t/i,n.updateProjectionMatrix(),r.setSize(t,i))}let m=new ResizeObserver(p);m.observe(e),p(),f();let h=new IntersectionObserver(([e])=>{d=e.isIntersecting},{threshold:.02});return h.observe(e),()=>{cancelAnimationFrame(u),h.disconnect(),m.disconnect(),s.dispose(),c.dispose(),r.dispose(),e.removeChild(r.domElement)}}var du=[[`10:42:08`,`TX ROOM`,`’06 Silverado 2500 transfer case`,`Answered · 2s`],[`10:43:51`,`CA ROOM`,`’14 Accord passenger fender, white`,`Answered · 3s`],[`10:47:12`,`FL ROOM`,`’09 Camry alternator`,`Answered · 2s`],[`10:49:40`,`OH ROOM`,`’17 F-150 3.5 EcoBoost long block`,`Answered · 5s`],[`10:52:03`,`AZ ROOM`,`’11 Jetta TDI turbo`,`Escalated → CA`],[`10:55:27`,`GA ROOM`,`’15 Altima CVT, 62k`,`Answered · 2s`],[`10:58:44`,`MI ROOM`,`’08 Sierra tailgate, black`,`Answered · 4s`],[`11:01:19`,`NY ROOM`,`’13 Rogue transfer case AWD`,`Answered · 3s`]],fu=[{n:`1`,title:`Broadcast the request`,copy:`A customer asks for a part you don't have. Pick up the handset and say it once — every yard in your region hears it instantly.`},{n:`2`,title:`A yard answers`,copy:`Members monitor the room hands-free. The yard sitting on your part unmutes and replies. Typical answer time is about two seconds.`},{n:`3`,title:`Close the sale`,copy:`Talk it through live or take it private. Your customer gets the part, both yards get paid — and the call is logged and recorded.`}],pu=[{label:`Inventory databases`,viz:`db`,time:`30–60 min`,flaw:`Stale listings, and you're result #38 of 40. The part shows in stock — until you drive out and it's already gone.`},{label:`Calling around`,viz:`hold`,time:`40+ min`,flaw:`Forty minutes of hold music to check five yards. Your customer already bought the part somewhere else.`},{label:`Facebook groups`,viz:`fb`,time:`Hours — if ever`,flaw:`Your post is buried within the hour, and nobody who can actually sell the part is watching the feed.`},{label:`The Hotline HQ network`,viz:`hot`,time:`2 seconds`,flaw:`One voice broadcast. Every counter in your region hears it right now, and the yard that has it answers you back in seconds.`,hot:!0}],mu=[{code:`1`,title:`Always on`,copy:`If the line ever drops, it reconnects on its own. Your phone stays in the room day and night without anyone touching it.`},{code:`2`,title:`Hands-free listening`,copy:`The room plays quietly at your counter. Pick up the handset to talk, put it down to go quiet. No apps, no logins, no screens.`},{code:`3`,title:`Phone or computer`,copy:`We ship you a desk phone that's ready to go — plug it in and you're on the air. Prefer the computer? It works in your browser too.`},{code:`4`,title:`Every call on record`,copy:`Every request is saved and recorded, along with who answered it. You can always go back and hear exactly what was said.`},{code:`5`,title:`Reach beyond your region`,copy:`You're not boxed into your own area. Your yard also reaches nearby regions, and you can switch rooms right from the phone.`},{code:`6`,title:`We watch your line 24/7`,copy:`If your line goes quiet, our team is alerted within minutes and gets you back on the air — usually before you even notice.`}];function hu({to:e,suffix:t=``,label:n}){let r=(0,c.useRef)(null),[i,a]=(0,c.useState)(0);return(0,c.useEffect)(()=>{let t=r.current;if(!t)return;let n=0,i=new IntersectionObserver(([t])=>{if(!t.isIntersecting)return;i.disconnect();let r=performance.now(),o=t=>{let i=Math.min((t-r)/1400,1);a(Math.round(e*Yl(i))),i<1&&(n=requestAnimationFrame(o))};n=requestAnimationFrame(o)},{threshold:.4});return i.observe(t),()=>{i.disconnect(),cancelAnimationFrame(n)}},[e]),(0,$.jsxs)(`div`,{ref:r,children:[(0,$.jsxs)(`strong`,{children:[i,t]}),(0,$.jsx)(`span`,{children:n})]})}var gu=[{file:`./broadcasts/clip1.mp3`,part:`2018 Honda Civic — Wreck Opinion`,yard:`Fast Auto Parts`,city:`Phoenix`,partData:[`2018`,`Honda`,`Civic`,`Wreck opinion`],responses:[{at:7.3,city:`Tucson`,yard:`A&G Auto Wrecking`,reply:`Got it`},{at:8.5,city:`Yuma`,yard:`J&A Auto Parts`,reply:`J&A got it`},{at:10,city:`Prescott`,yard:`ODR Auto Wrecking`,reply:`Got two`},{at:11.5,city:`Flagstaff`,yard:`Fast Auto Parts`,reply:`In stock`}]},{file:`./broadcasts/clip2.mp3`,part:`2020 Camry — Trunk & Taillights`,yard:`Reeves Auto Wrecking`,city:`Tucson`,partData:[`2020`,`Toyota`,`Camry`,`Trunk & taillights`],responses:[{at:5.2,city:`Phoenix`,yard:`Reeves`,reply:`Checking`},{at:8.5,city:`Prescott`,yard:`Phoenix Salvage`,reply:`Got it`},{at:12.5,city:`Yuma`,yard:`Chapin Auto`,reply:`Thank you`}]},{file:`./broadcasts/clip3.mp3`,part:`2021 Chevy Tahoe — Wreck Opinion`,yard:`Carrillo Auto Parts`,city:`Flagstaff`,partData:[`2021`,`Chevrolet`,`Tahoe`,`Wreck opinion`],responses:[{at:3.8,city:`Phoenix`,yard:`J&A Auto Parts`,reply:`J&A got it`},{at:5.5,city:`Tucson`,yard:`Parts Plus`,reply:`Ready to go`},{at:7,city:`Prescott`,yard:`Jordan Auto`,reply:`Got it`}]},{file:`./broadcasts/clip4.mp3`,part:`2018 Honda Civic — Rack & Pinion`,yard:`Jordan Auto Wrecking`,city:`Prescott`,partData:[`2018`,`Honda`,`Civic`,`Rack & pinion`],responses:[{at:9.5,city:`Phoenix`,yard:`Jordan Auto`,reply:`Got one`},{at:11.5,city:`Tucson`,yard:`A&G Auto`,reply:`Got a 15`},{at:14,city:`Flagstaff`,yard:`Fast Auto Parts`,reply:`In stock`}]}];function _u(){let e=(0,c.useRef)(null),t=(0,c.useRef)(null),n=(0,c.useRef)(null),l=(0,c.useRef)(null),u=(0,c.useRef)(null),d=(0,c.useRef)(null);(0,c.useRef)(null);let f=(0,c.useRef)(null),[p,m]=(0,c.useState)(!1),[h,g]=(0,c.useState)(!1),[_,v]=(0,c.useState)({deals:0,revenue:0}),[y,b]=(0,c.useState)(0),[x,S]=(0,c.useState)(!1),[C,w]=(0,c.useState)({deals:0,revenue:0}),T=(0,c.useRef)(null),E=(0,c.useRef)(null),D=(0,c.useRef)(0),ee=(0,c.useRef)([]),[O,k]=(0,c.useState)(`idle`),[A,j]=(0,c.useState)(null),M=()=>{ee.current.forEach(clearTimeout),ee.current=[]},te=()=>{let e=E.current,t=T.current;if(!e)return;if(O===`playing`){e.pause(),M(),k(`idle`),j(null),t?.resumeAuto();return}let n=D.current%gu.length,r=gu[n];D.current=n+1,e.src=r.file,k(`playing`),j(r),t?.pauseAuto(),M(),e.play().then(()=>{t?.fireSellCallWithData(r.city,r.partData),r.responses&&r.responses.forEach(e=>{let n=setTimeout(()=>{t?.fireResponse(r.city,e.city,e.yard,e.reply)},e.at*1e3);ee.current.push(n)})}).catch(()=>{})};(0,c.useEffect)(()=>{let e=E.current;if(!e)return;let t=()=>{let e=T.current;M(),k(`idle`),j(null),e?.resumeAuto()};return e.addEventListener(`ended`,t),()=>e.removeEventListener(`ended`,t)},[]),(0,c.useEffect)(()=>{let t=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches;if(!e.current)return;let n=su(e.current,{reducedMotion:t,onReply:e=>v(t=>({deals:t.deals+1,revenue:t.revenue+e}))});return T.current=n,()=>{T.current=null,n.dispose()}},[]),(0,c.useEffect)(()=>{if(!t.current)return;let e=lu(t.current);return f.current=e,()=>{f.current=null,e.dispose()}},[]),(0,c.useEffect)(()=>{let e=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches;if(!(!n.current||e))return uu(n.current)},[]),(0,c.useEffect)(()=>{let e=l.current?.querySelectorAll(`.l2-reveal`)??[],t=new IntersectionObserver(e=>e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`l2-in`),t.unobserve(e.target))}),{threshold:.15});return e.forEach(e=>t.observe(e)),()=>t.disconnect()},[]),(0,c.useEffect)(()=>{let e=0,t=()=>{cancelAnimationFrame(e),e=requestAnimationFrame(()=>{let e=document.documentElement,t=e.scrollHeight-window.innerHeight,n=t>0?Math.min(e.scrollTop/t,1):0;d.current&&(d.current.style.height=`${n*100}%`)})};return window.addEventListener(`scroll`,t,{passive:!0}),t(),()=>{window.removeEventListener(`scroll`,t),cancelAnimationFrame(e)}},[]);function ne(){x||!f.current||(S(!0),f.current.run(Hl[y],{onSale:(e,t)=>w(n=>({deals:n.deals+1,revenue:n.revenue+e,bids:t})),onDone:()=>S(!1)}))}let N=Hl[y];return(0,$.jsxs)(`div`,{className:`l2`,ref:l,children:[(0,$.jsx)(`style`,{children:i}),(0,$.jsx)(`style`,{children:vu}),(0,$.jsx)(r,{title:`Hotline HQ — Find Any Used Auto Part in 2 Seconds | Salvage Yard Parts Locator`,description:`Stop losing sales when you don't have the part. Broadcast once to 500+ salvage yards — get an answer in 2 seconds. The fastest way to locate and sell used auto parts.`,keywords:`find used auto parts fast, used auto parts locator, salvage yard parts finder, locate used car parts, sell used auto parts to yards, junkyard parts sourcing, used OEM parts supplier, auto parts interchange, salvage yard parts network, used car parts wholesale, auto recycler parts locator, find junkyard parts near me`,canonicalUrl:`https://redlineusedautoparts.com/hotlinehq/`,path:`/`,jsonLd:a()}),(0,$.jsx)(`div`,{className:`l2-wire`,"aria-hidden":`true`,children:(0,$.jsx)(`div`,{className:`l2-wire-fill`,ref:d})}),(0,$.jsxs)(`header`,{className:`l2-nav`,children:[(0,$.jsx)(`a`,{className:`l2-logo`,href:`#top`,children:(0,$.jsx)(o,{})}),(0,$.jsxs)(`nav`,{className:`l2-nav-links`,children:[(0,$.jsx)(`a`,{href:`#how`,children:`How it works`}),(0,$.jsx)(`a`,{href:`#try`,children:`Try it`}),(0,$.jsx)(`a`,{href:`#rooms`,children:`Coverage`}),(0,$.jsx)(`a`,{href:`./own-a-hotline`,children:`Own a hotline`}),(0,$.jsx)(`a`,{href:`/client/login`,className:`l2-nav-login`,children:`Login`}),(0,$.jsx)(`a`,{href:`/client/signup`,className:`l2-nav-cta`,children:`Sign Up Free`})]})]}),(0,$.jsxs)(`section`,{className:`l2-hero`,id:`top`,children:[(0,$.jsx)(`div`,{className:`l2-hero-bg`,ref:e,"aria-hidden":`true`}),(0,$.jsx)(`div`,{className:`l2-hero-scrim`,"aria-hidden":`true`}),(0,$.jsxs)(`div`,{className:`l2-stage-chip l2-stage-tl`,children:[(0,$.jsx)(`span`,{className:`l2-live-dot`}),` Live network · 12 regional rooms`]}),(0,$.jsx)(`div`,{className:`l2-stage-chip l2-stage-tr`,children:`◉ Click any city to fire a sell call`}),(0,$.jsxs)(`div`,{className:`l2-stage-chip l2-stage-br`,children:[`▲ $`,_.revenue.toLocaleString(),` matched · `,_.deals,` deals (demo feed)`]},_.deals),(0,$.jsxs)(`div`,{className:`l2-hero-copy`,children:[(0,$.jsx)(`p`,{className:`l2-eyebrow`,children:`The parts-locating voice network for auto recyclers`}),(0,$.jsxs)(`h1`,{children:[`Every “we don’t have it” is a customer walking out. `,(0,$.jsx)(`em`,{children:`It doesn’t have to be.`})]}),(0,$.jsx)(`p`,{className:`l2-sub`,children:`The part you don’t have is sitting in somebody’s yard. Hotline HQ is the always-on voice network connecting 500+ salvage yards — broadcast once, get an answer in seconds, and keep the sale.`}),(0,$.jsxs)(`div`,{className:`l2-hero-ctas`,children:[(0,$.jsx)(`a`,{className:`l2-btn l2-btn-hot`,href:`/client/signup`,children:`Sign Up Free`}),(0,$.jsx)(`a`,{className:`l2-btn l2-btn-ghost`,href:`/client/login`,children:`Login`})]}),(0,$.jsx)(`audio`,{ref:E,preload:`none`}),(0,$.jsxs)(`button`,{type:`button`,className:`l2-listen-btn ${O===`playing`?`on`:``}`,onClick:te,children:[(0,$.jsx)(`span`,{className:`l2-listen-icon`,children:O===`playing`?(0,$.jsxs)(`span`,{className:`l2-listen-eq`,children:[(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{})]}):(0,$.jsxs)(`svg`,{viewBox:`0 0 24 24`,width:`20`,height:`20`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`,children:[(0,$.jsx)(`polygon`,{points:`11 5 6 9 2 9 2 15 6 15 11 19 11 5`}),(0,$.jsx)(`path`,{d:`M15.54 8.46a5 5 0 0 1 0 7.07`}),(0,$.jsx)(`path`,{d:`M19.07 4.93a10 10 0 0 1 0 14.14`})]})}),(0,$.jsx)(`span`,{className:`l2-listen-text`,children:O===`playing`?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`strong`,{children:`Now playing`}),(0,$.jsx)(`span`,{children:A?.part})]}):(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`strong`,{children:`Listen to a real sell call`}),(0,$.jsx)(`span`,{children:`Hear a live broadcast from the network`})]})})]})]}),(0,$.jsxs)(`div`,{className:`l2-stats`,children:[(0,$.jsx)(hu,{to:500,suffix:`+`,label:`member yards`}),(0,$.jsx)(hu,{to:12,label:`regional rooms`}),(0,$.jsx)(hu,{to:2,suffix:`s`,label:`typical answer`}),(0,$.jsx)(hu,{to:24,suffix:`/7`,label:`line monitoring`})]})]}),(0,$.jsx)(`div`,{className:`l2-ticker`,"aria-hidden":`true`,children:(0,$.jsx)(`div`,{className:`l2-ticker-track`,children:[...du,...du].map((e,t)=>(0,$.jsxs)(`span`,{className:`l2-tick`,children:[(0,$.jsx)(`span`,{className:`l2-tick-time`,children:e[0]}),(0,$.jsx)(`span`,{className:`l2-tick-room`,children:e[1]}),(0,$.jsx)(`span`,{className:`l2-tick-part`,children:e[2]}),(0,$.jsx)(`span`,{className:`l2-tick-status ${e[3].startsWith(`Answered`)?`ok`:`esc`}`,children:e[3]})]},t))})}),(0,$.jsxs)(`section`,{className:`l2-section l2-video-section`,id:`demo`,children:[(0,$.jsxs)(`div`,{className:`l2-section-head l2-center l2-reveal`,children:[(0,$.jsx)(`p`,{className:`l2-kicker`,children:`See it run`}),(0,$.jsx)(`h2`,{children:`Watch a part get located.`}),(0,$.jsx)(`p`,{className:`l2-lede`,children:`This is the actual hotline — a real broadcast going out, and a yard answering back. No demo environment, no mockups.`})]}),(0,$.jsxs)(`div`,{className:`l2-video-frame l2-reveal`,children:[(0,$.jsx)(`video`,{ref:u,src:`./hotlinehq.mp4`,controls:h,preload:`metadata`,playsInline:!0,onEnded:()=>g(!1)}),!h&&(0,$.jsxs)(`button`,{className:`l2-video-overlay`,onClick:()=>{g(!0),u.current?.play()},"aria-label":`Play video`,children:[(0,$.jsx)(`span`,{className:`l2-play-btn`,"aria-hidden":`true`}),(0,$.jsx)(`span`,{className:`l2-play-label`,children:`Watch the hotline in action · 1 min`})]})]})]}),(0,$.jsxs)(`section`,{className:`l2-section l2-band`,children:[(0,$.jsxs)(`div`,{className:`l2-section-head l2-reveal`,children:[(0,$.jsx)(`p`,{className:`l2-kicker`,children:`The problem`}),(0,$.jsx)(`h2`,{children:`How long does it take you to find a part? 30\xA0minutes? An\xA0hour?`}),(0,$.jsxs)(`p`,{className:`l2-lede l2-lede-wide l2-two-sec`,children:[`Our network average is `,(0,$.jsx)(`strong`,{children:`2\xA0seconds.`})]})]}),(0,$.jsx)(`div`,{className:`l2-compare`,children:pu.map((e,t)=>(0,$.jsxs)(`div`,{className:`l2-compare-card l2-reveal ${e.hot?`hot`:``}`,style:{transitionDelay:`${t*90}ms`},children:[(0,$.jsx)(`p`,{className:`l2-compare-label`,children:e.label}),(0,$.jsxs)(`div`,{className:`l2-compare-time ${e.hot?`good`:``}`,children:[(0,$.jsx)(`span`,{children:`Avg response`}),(0,$.jsx)(`strong`,{children:e.time})]}),(0,$.jsx)(`p`,{className:`l2-compare-copy`,children:e.flaw}),e.hot&&(0,$.jsx)(`span`,{className:`l2-compare-badge`,children:`This is Hotline HQ`})]},e.label))})]}),(0,$.jsx)(`section`,{className:`l2-mid-cta-band`,id:`get-started`,children:(0,$.jsxs)(`div`,{className:`l2-mid-cta-inner l2-reveal`,children:[(0,$.jsx)(`h2`,{children:`Ready to stop losing sales?`}),(0,$.jsx)(`p`,{children:`Join 500+ yards already on the network. Set up takes 30 seconds.`}),(0,$.jsxs)(`div`,{style:{display:`flex`,gap:`14px`,justifyContent:`center`,marginBottom:`28px`,flexWrap:`wrap`},children:[(0,$.jsx)(`a`,{className:`l2-btn l2-btn-hot`,href:`/client/signup`,style:{background:`#fff`,color:`var(--red)`,boxShadow:`0 8px 24px -8px rgba(0,0,0,0.2)`,fontSize:`15.5px`,padding:`14px 32px`},children:`Sign Up Free`}),(0,$.jsx)(`a`,{className:`l2-btn l2-btn-ghost`,href:`/client/login`,style:{border:`2px solid rgba(255,255,255,0.4)`,color:`#fff`,background:`transparent`,fontSize:`15.5px`,padding:`14px 32px`},children:`Login`})]}),(0,$.jsx)(`p`,{className:`l2-contact-fine`,style:{marginBottom:`20px`},children:`Or reach out directly — a human answers, no bots.`}),(0,$.jsxs)(`div`,{className:`l2-contact-btns`,children:[(0,$.jsxs)(`a`,{className:`l2-contact-btn wa-btn`,href:`https://wa.me/14246260202?text=Hi%2C%20I%27m%20interested%20in%20Hotline%20HQ%20for%20my%20yard`,target:`_blank`,rel:`noopener noreferrer`,children:[(0,$.jsx)(`span`,{className:`l2-contact-icon wa`,children:(0,$.jsx)(`svg`,{width:`24`,height:`24`,viewBox:`0 0 24 24`,fill:`currentColor`,children:(0,$.jsx)(`path`,{d:`M19.05 4.91A9.82 9.82 0 0012.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38a9.9 9.9 0 004.74 1.21h.01c5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.91-7.01zM12.04 20.15h-.01a8.23 8.23 0 01-4.19-1.15l-.3-.18-3.12.82.83-3.04-.2-.31a8.21 8.21 0 01-1.26-4.38c0-4.54 3.7-8.24 8.25-8.24 2.2 0 4.27.86 5.83 2.42a8.18 8.18 0 012.41 5.83c0 4.54-3.7 8.24-8.24 8.24zm4.52-6.16c-.25-.12-1.47-.72-1.69-.81-.23-.08-.39-.12-.56.12-.16.25-.64.81-.79.97-.14.16-.29.18-.54.06-.25-.12-1.05-.39-2-1.23-.74-.66-1.23-1.47-1.38-1.72-.14-.25-.02-.39.11-.51.11-.11.25-.29.37-.43.12-.14.16-.25.25-.41.08-.16.04-.31-.02-.43-.06-.12-.56-1.34-.76-1.84-.2-.48-.4-.42-.56-.43h-.48c-.16 0-.43.06-.66.31-.23.25-.86.84-.86 2.05 0 1.21.88 2.38 1 2.55.12.16 1.74 2.66 4.21 3.73.59.25 1.05.41 1.41.52.59.19 1.13.16 1.56.1.48-.07 1.47-.6 1.67-1.18.21-.58.21-1.07.14-1.18-.06-.1-.22-.16-.47-.28z`})})}),(0,$.jsxs)(`span`,{className:`l2-contact-text`,children:[(0,$.jsx)(`strong`,{children:`WhatsApp on this`}),(0,$.jsx)(`span`,{children:`(424) 626-0202`})]}),(0,$.jsx)(`span`,{className:`l2-contact-arrow`,children:(0,$.jsx)(`svg`,{width:`16`,height:`12`,viewBox:`0 0 18 14`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.4`,strokeLinecap:`round`,strokeLinejoin:`round`,children:(0,$.jsx)(`path`,{d:`M1 7h15M11 1l5 6-5 6`})})})]}),(0,$.jsxs)(`a`,{className:`l2-contact-btn sms-btn`,href:`sms:+18335645350?body=Hi%2C%20I%27m%20interested%20in%20Hotline%20HQ%20for%20my%20yard`,children:[(0,$.jsx)(`span`,{className:`l2-contact-icon sms`,children:(0,$.jsxs)(`svg`,{width:`24`,height:`24`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`,children:[(0,$.jsx)(`path`,{d:`M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z`}),(0,$.jsx)(`path`,{d:`M8 10h.01M12 10h.01M16 10h.01`})]})}),(0,$.jsxs)(`span`,{className:`l2-contact-text`,children:[(0,$.jsx)(`strong`,{children:`Text it to`}),(0,$.jsx)(`span`,{children:`(833) 564-5350`})]}),(0,$.jsx)(`span`,{className:`l2-contact-arrow`,children:(0,$.jsx)(`svg`,{width:`16`,height:`12`,viewBox:`0 0 18 14`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.4`,strokeLinecap:`round`,strokeLinejoin:`round`,children:(0,$.jsx)(`path`,{d:`M1 7h15M11 1l5 6-5 6`})})})]})]}),(0,$.jsx)(`p`,{className:`l2-contact-fine`,children:`A human answers. No bots, no drip emails.`})]})}),(0,$.jsxs)(`section`,{className:`l2-section`,id:`how`,children:[(0,$.jsxs)(`div`,{className:`l2-section-head l2-center l2-reveal`,children:[(0,$.jsx)(`p`,{className:`l2-kicker`,children:`How it works`}),(0,$.jsx)(`h2`,{children:`One broadcast. One answer. One sale saved.`})]}),(0,$.jsx)(`div`,{className:`l2-steps`,children:fu.map((e,t)=>(0,$.jsxs)(`div`,{className:`l2-step l2-reveal`,style:{transitionDelay:`${t*110}ms`},children:[(0,$.jsx)(`span`,{className:`l2-step-n`,children:e.n}),(0,$.jsx)(`h3`,{children:e.title}),(0,$.jsx)(`p`,{children:e.copy})]},e.n))}),(0,$.jsx)(`p`,{className:`l2-footnote l2-reveal`,children:`Unanswered? The request is logged, escalated to neighboring rooms, and sent to the entire network as a message — a miss in your region isn’t a miss on the network.`})]}),(0,$.jsxs)(`section`,{className:`l2-section l2-band`,id:`try`,children:[(0,$.jsxs)(`div`,{className:`l2-section-head l2-center l2-reveal`,children:[(0,$.jsx)(`p`,{className:`l2-kicker`,children:`Try it yourself`}),(0,$.jsx)(`h2`,{children:`Run a sell call. Watch the yards bid.`}),(0,$.jsx)(`p`,{className:`l2-lede`,children:`Pick a part and put it on the air. This is exactly what your counter person does — minus the mouse.`})]}),(0,$.jsxs)(`div`,{className:`l2-demo l2-reveal`,children:[(0,$.jsxs)(`div`,{className:`l2-demo-panel`,children:[(0,$.jsx)(`p`,{className:`l2-demo-label`,children:`Part request`}),(0,$.jsxs)(`div`,{className:`l2-part-picker`,children:[(0,$.jsx)(`button`,{type:`button`,"aria-label":`Previous part`,onClick:()=>b(e=>(e+Hl.length-1)%Hl.length),disabled:x,children:`‹`}),(0,$.jsxs)(`div`,{className:`l2-part-display`,children:[(0,$.jsxs)(`span`,{className:`l2-part-line`,children:[N[0],` | `,N[1],` | `,N[2]]}),(0,$.jsx)(`span`,{className:`l2-part-name`,children:N[3]})]}),(0,$.jsx)(`button`,{type:`button`,"aria-label":`Next part`,onClick:()=>b(e=>(e+1)%Hl.length),disabled:x,children:`›`})]}),(0,$.jsx)(`button`,{type:`button`,className:`l2-broadcast-btn ${x?`onair`:``}`,onClick:ne,disabled:x,children:x?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`span`,{className:`l2-onair-dot`}),` ON AIR…`]}):C.deals>0?`Broadcast another`:`Broadcast it`}),(0,$.jsxs)(`div`,{className:`l2-scoreboard`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:C.deals}),(0,$.jsx)(`span`,{children:`deals closed`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`strong`,{children:[`$`,C.revenue.toLocaleString()]}),(0,$.jsx)(`span`,{children:`revenue recovered`})]})]}),(0,$.jsx)(`p`,{className:`l2-demo-fine`,children:`Simulated replies. On the real network this takes one spoken sentence.`})]}),(0,$.jsxs)(`div`,{className:`l2-demo-stage`,children:[(0,$.jsx)(`div`,{className:`l2-demo-canvas`,ref:t,"aria-hidden":`true`}),(0,$.jsxs)(`div`,{className:`l2-stage-chip l2-demo-chip`,children:[(0,$.jsx)(`span`,{className:`l2-live-dot`}),` AZ room · your yard + 8 neighbors`]})]})]})]}),(0,$.jsxs)(`section`,{className:`l2-section`,id:`rooms`,children:[(0,$.jsxs)(`div`,{className:`l2-section-head l2-reveal`,children:[(0,$.jsx)(`p`,{className:`l2-kicker`,children:`Coverage`}),(0,$.jsx)(`h2`,{children:`Twelve rooms. Every major market.`}),(0,$.jsx)(`p`,{className:`l2-lede`,children:`Your yard lives in its home room and is profiled into nearby regions — and you can switch rooms straight from the phone when the hunt goes wide.`})]}),(0,$.jsx)(`div`,{className:`l2-rooms`,children:zl.map((e,t)=>(0,$.jsxs)(`div`,{className:`l2-room l2-reveal`,style:{transitionDelay:`${t*40}ms`},children:[(0,$.jsxs)(`span`,{className:`l2-room-code`,children:[`RM-`,String(t+1).padStart(2,`0`)]}),(0,$.jsx)(`span`,{className:`l2-room-name`,children:e.name.charAt(0)+e.name.slice(1).toLowerCase()}),(0,$.jsx)(`span`,{className:`l2-room-live`,children:`● Live`})]},e.name))}),(0,$.jsx)(`div`,{className:`l2-reveal`,style:{textAlign:`center`,marginTop:`40px`},children:(0,$.jsx)(`a`,{className:`l2-btn l2-btn-hot`,href:`/client/signup`,children:`Sign Up Free — pick your room`})})]}),(0,$.jsxs)(`section`,{className:`l2-section l2-band`,id:`system`,children:[(0,$.jsxs)(`div`,{className:`l2-section-head l2-center l2-reveal`,children:[(0,$.jsx)(`p`,{className:`l2-kicker`,children:`The system`}),(0,$.jsx)(`h2`,{children:`Built like shop equipment, not software.`}),(0,$.jsx)(`p`,{className:`l2-lede`,children:`No apps to update, no passwords on sticky notes. It's a piece of counter equipment that pays its membership back on one saved sale.`})]}),(0,$.jsx)(`div`,{className:`l2-features`,children:mu.map((e,t)=>(0,$.jsxs)(`div`,{className:`l2-feature l2-reveal`,style:{transitionDelay:`${t*70}ms`},children:[(0,$.jsx)(`span`,{className:`l2-feature-code`,children:e.code}),(0,$.jsx)(`h3`,{children:e.title}),(0,$.jsx)(`p`,{children:e.copy})]},e.code))})]}),(0,$.jsxs)(`section`,{className:`l2-join`,id:`join`,children:[(0,$.jsx)(`div`,{className:`l2-join-bg`,ref:n,"aria-hidden":`true`}),(0,$.jsxs)(`div`,{className:`l2-join-inner`,children:[(0,$.jsxs)(`div`,{className:`l2-reveal`,children:[(0,$.jsx)(`p`,{className:`l2-kicker l2-kicker-light`,children:`Membership`}),(0,$.jsx)(`h2`,{children:`One flat membership. Your whole region on the line.`}),(0,$.jsxs)(`ul`,{className:`l2-join-list`,children:[(0,$.jsx)(`li`,{children:`Flat monthly fee per yard — no per-call charges`}),(0,$.jsx)(`li`,{children:`Preconfigured desk phone or browser client included`}),(0,$.jsx)(`li`,{children:`Live in your regional room the day the phone arrives`}),(0,$.jsx)(`li`,{children:`Call recordings and answer-rate reporting included`})]})]}),(0,$.jsxs)(`div`,{className:`l2-form l2-reveal`,style:{textAlign:`center`},children:[(0,$.jsx)(`p`,{className:`l2-form-title`,children:`Get started in 30 seconds`}),(0,$.jsx)(`a`,{className:`l2-btn l2-btn-hot`,href:`/client/signup`,style:{width:`100%`,display:`block`,textAlign:`center`,marginBottom:`14px`},children:`Sign Up Free`}),(0,$.jsxs)(`p`,{style:{color:`rgba(255,255,255,0.6)`,fontSize:`14px`,marginBottom:`14px`},children:[`Already have an account? `,(0,$.jsx)(`a`,{href:`/client/login`,style:{color:`#fff`,fontWeight:600,textDecoration:`underline`},children:`Login`})]}),(0,$.jsx)(`p`,{className:`l2-form-fine`,children:`No credit card required. Set up your yard in minutes.`})]})]})]}),(0,$.jsx)(s,{}),(0,$.jsx)(`a`,{className:`l2-sticky-cta`,href:`/client/signup`,children:`Sign Up Free`})]})}var vu=`
