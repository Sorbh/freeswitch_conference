...
keywords:
  - best place to sell used auto parts online
  - where to sell used auto parts
  - how to sell used auto parts online
  - sell my auto parts online
  - where can i sell used auto parts online
  - selling salvage parts online
  - used auto parts marketplace
toc:
  - id: best-options
    label: "The 7 best places to sell used auto parts"
  - id: ebay-motors
    label: "1. eBay Motors"
  - id: facebook-marketplace
    label: "2. Facebook Marketplace"
  - id: car-part-com
    label: "3. Car-Part.com"
  - id: craigslist
    label: "4. Craigslist"
  - id: partcycle
    label: "5. PartCycle"
  - id: lkq-hollander
    label: "6. LKQ / Hollander"
  - id: hotline-hq
    label: "7. Hotline HQ"
  - id: comparison-summary
    label: "Which platform fits your operation"
  - id: stacking-channels
    label: "Why one channel isn't enough"
faq:
  - q: What is the best place to sell used auto parts online?
    a: It depends on your operation. For individual sellers with a handful of parts, eBay Motors offers the widest buyer reach at the cost of roughly 15% in fees. For salvage yards and dismantlers moving volume, Car-Part.com provides passive national exposure through inventory databases, while voice networks like Hotline HQ deliver the fastest yard-to-yard sales with 2-second average response times. Most successful yards use two or three channels together.
  - q: How much does eBay charge to sell auto parts?
    a: eBay charges an insertion fee (first 250 listings per month are free for most sellers) plus a final value fee of approximately 14.35% of the sale price, including shipping, plus a $0.30 per-order surcharge. eBay Motors Parts & Accessories follows this standard fee structure. Payment processing is included in the final value fee since eBay manages payments directly.
  - q: Can I sell used auto parts on Facebook Marketplace?
    a: Yes. Facebook Marketplace charges no listing fees and no commission for local pickup sales. If you use Facebook's shipping option, a 10% selling fee applies (minimum $1.00). Most used auto parts transactions on Facebook happen as local pickup due to the size and weight of parts, making it effectively free to sell there.
  - q: Is it worth listing salvage parts on Craigslist in 2026?
    a: Craigslist is still free and still gets traffic, but buyer quality has declined. Expect more no-shows and lowball offers than on specialized platforms. It works best for heavy, hard-to-ship parts like engines and transmissions where local pickup is the only realistic option. For a salvage yard, the time spent managing Craigslist inquiries often outweighs the savings from zero fees.
  - q: What is the fastest way to sell used auto parts?
    a: Voice hotline networks are the fastest channel for yard-to-yard sales. On the Hotline HQ network, a single broadcast reaches 100+ yards simultaneously, and the average response time is approximately 2 seconds. Online marketplaces like eBay reach more individual buyers but sales typically take days to weeks, not minutes.
  - q: Do I need a business license to sell used auto parts online?
    a: Requirements vary by state. Occasional sellers typically don't need a license for selling personal vehicle parts. However, if you're regularly buying and reselling auto parts for profit, most states require a business license and potentially a salvage dealer license. Some platforms like eBay require tax information once you hit certain sales thresholds (currently $600 annually triggers a 1099-K). Check your state's Department of Motor Vehicles and revenue department for specific requirements.
coverImage: /images/blog/best-places-to-sell-used-auto-parts-online/selling-auto-parts-online.webp
coverImageAlt: Salvage yard office with multiple screens showing online marketplace listings and used auto parts on shelving
ogImage: /images/blog/best-places-to-sell-used-auto-parts-online/selling-auto-parts-online.webp
---

![Salvage yard office with multiple screens showing online marketplace listings and used auto parts on shelving](/images/blog/best-places-to-sell-used-auto-parts-online/selling-auto-parts-online.webp)
...
For a broader look at how yards approach multi-channel selling, see our guide on [how salvage yards sell more parts](/blog/guides/how-salvage-yards-sell-more-parts).

## 1. eBay Motors {#ebay-motors}

**Best for:** Individual sellers and yards that want the widest consumer reach

**How it works:** You create a listing with photos, part details, fitment data, and price. Buyers find your listing through eBay search or Google Shopping. When a part sells, you ship it or arrange local pickup. eBay handles payment processing.

eBay Motors is the 800-pound gorilla of online auto parts sales. The eBay marketplace overall sees roughly 133 million active buyers worldwide ([eBay Inc.](https://www.ebayinc.com/), Q1 2025 earnings). The Parts & Accessories category is one of eBay's largest, and eBay Motors consistently ranks among the top results in Google for used auto parts searches.

**Pricing and fees:** eBay gives most sellers 250 free insertion listings per month. After that, insertion fees are typically $0.35 per listing. The final value fee runs approximately 14.35% of the total sale amount (including shipping), plus a $0.30 per-order surcharge. For a $200 transmission, you'd pay about $29 in fees after the sale closes.
...
- eBay's fitment tools help buyers find compatible parts
- Built-in payment processing and buyer/seller protections
- Strong Google Shopping and organic search visibility
...
**Pricing and fees:** Zero fees for local pickup transactions. If you use Facebook's shipping option (available for some categories), a 10% selling fee applies with a $1.00 minimum. Most used auto parts transactions happen locally, so you'll typically pay nothing.

**Speed of sale:** Fast for common, in-demand parts in populated areas. Slow or nonexistent in rural markets. Expect a lot of "Is this still available?" messages that go nowhere.

**Reach:** Broad but local. Your listing is shown primarily to buyers within a radius you set (typically 40 to 100 miles). National reach is possible through shipping, but that defeats the main advantage of the platform.
...
**Best for:** Salvage yards that want passive, always-on national exposure

**How it works:** Yards running compatible inventory management software (especially Checkmate, which Car-Part.com owns) upload their inventory data to Car-Part.com's database. Buyers search by year, make, model, and part type. Results show which yards have the part, along with price and condition. The buyer then contacts the yard directly to arrange purchase and shipping.

Car-Part.com is the industry standard for used parts search. Over 200 million parts are searchable in their database ([Car-Part.com](https://www.car-part.com/)). No other platform comes close in raw inventory size. If you run a salvage yard and you're not on Car-Part.com, you're invisible to a large chunk of the buying market.
...
## 4. Craigslist {#craigslist}

**Best for:** Free, no-frills local listings for heavy or hard-to-ship parts
...
**Speed of sale:** Unpredictable. You might sell a popular part the same day or re-post the same listing for months with no bites. Craigslist's audience for auto parts has shrunk as Facebook Marketplace and specialized platforms have gained ground.

**Reach:** Local only. Each posting is tied to a specific metro area. There's no national search and no way to reach buyers outside your region.
...
- Declining traffic for auto parts compared to five years ago
- No seller reputation or review system

## 5. PartCycle {#partcycle}

**Best for:** Yards that want a B2B marketplace with lower fees than consumer platforms
...
**Best for:** Yards already in the LKQ network or using Hollander interchange data

**How it works:** LKQ Corporation is the largest buyer and reseller of recycled auto parts in North America. Hollander, which LKQ acquired, provides the interchange numbering system used across the industry to match parts across different vehicles. If you're an LKQ affiliate or supplier, parts move through their national distribution network. For independent yards, Hollander interchange numbers are essential for listing parts accurately on any platform.
...
**Pros:**
- Access to the largest auto parts distribution network in North America
- Reliable wholesale buyer if you become an LKQ supplier
- Hollander interchange numbers are the industry standard for parts identification
- Volume purchasing means faster inventory turnover
- LKQ handles logistics, distribution, and customer service on their end

**Cons:**
- Wholesale pricing means lower per-part margins
- LKQ competes with independent yards for the same buyers
...
**Pricing and fees:** Flat monthly membership fee. No per-call charges, no listing fees, no per-sale commission. A preconfigured desk phone ships with your membership. For current pricing, see [HotlineHQ.com](https://www.hotlinehq.com).
...
Seven platforms, seven different strengths. Here's the short version of which one fits whom:

**You're a salvage yard or dismantler moving volume:**
...
## Why One Channel Isn't Enough {#stacking-channels}

The yards that consistently move the most inventory don't rely on a single platform. They stack channels. A typical high-volume yard might run Car-Part.com for passive database exposure, Hotline HQ for real-time yard-to-yard sales, and eBay Motors for direct-to-consumer sales on high-margin parts.

Each channel solves a different problem. Car-Part.com catches buyers who search. Hotline HQ catches buyers who broadcast. eBay catches consumers who Google. Facebook catches locals who browse.

The risk of relying on one channel is obvious: if eBay raises fees, if Car-Part.com's data gets stale, if Facebook changes its algorithm, your sales drop overnight. Two or three channels give you redundancy and reach different buyer types.

Start with the channel that matches how your operation already works. If you have good inventory data, add Car-Part.com. If you have a counter person who can respond quickly, add Hotline HQ. If you have someone who can photograph and list parts, add eBay. Then expand from there.

For a deeper look at building a multi-channel sales strategy, read our guide on [how salvage yards sell more parts](/blog/guides/how-salvage-yards-sell-more-parts). And if you want to understand how buyers on the other side find your parts across these channels, see our [guide to finding used auto parts online](/blog/guides/find-used-auto-parts-online-guide). You can also explore our main [sell used auto parts](/sell-used-auto-parts) page for a quick overview of how Hotline HQ fits into your selling workflow.
