...
faqs:
  ...
  - q: "Can answered broadcasts also be listed on the marketplace?"
    a: "Right now, only unanswered broadcasts get auto-listed. Answered ones are assumed resolved on the hotline."
  - q: "How accurate is the AI part extraction?"
    a: "The system uses Whisper for transcription and a specialized AI model for part extraction. It picks up year, make, model, and common part names reliably. Heavy accents or unusual parts might need a manual look."
  - q: "Can I respond to a marketplace listing if I'm not on the network?"
    a: "Yes. Anyone can view the listing and submit a response with their name and phone number. The broadcaster gets an email with the details."
  - q: "Do marketplace listings expire?"
    a: "Listings stay visible but get marked as stale after a while. Fresh ones (under 2 hours) show a \"fresh\" tag."
related:
  - parts-marketplace
  - broadcast-recording
  - notifications
