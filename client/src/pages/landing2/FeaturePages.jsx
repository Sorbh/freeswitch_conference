...
export function SellPartsPage() {
  ...
  const FAQS = [
    ...
    { q: "How is this different from calling yards one by one?", a: "Instead of one buyer calling one yard at a time, one buyer broadcasts to 97 yards simultaneously. For sellers, this means you hear every request without anyone having to dial your number. You don't need to answer individual phone calls. Just listen to the conference line and speak up when you have what someone needs." },
    { q: "What types of businesses use Hotline HQ?", a: "Auto dismantlers, salvage yards, junkyards, used parts dealers, and recyclers. Some shops that pull their own parts also use the network to find parts they don't carry. The network is purpose-built for the used auto parts industry, not a general marketplace." },
  ...
  return (
    <div className="l2">
      ...
      <section className="fp-section">
        ...
        <div className="fp-advantages">
          {[
            { title: "Grade A: 60-70% of new OEM", copy: "Low mileage, excellent cosmetic and mechanical condition. No visible damage, clean connectors, original paint. These are the parts that command premium pricing: engines under 80K miles, un-cracked headlight assemblies, and rust-free body panels from dry-climate vehicles." },
    ...
    >
        <section id="what-is">
          ...
          <p>
            ...
            conference bridges. The always-on model means yards don't need to call anyone; they just listen. When a request
        ...
        <section id="how-it-works">
          ...
          <ol className="bl-steps">
            ...
            <li><strong>Listen.</strong> Every yard in the regional room hears the request through their desk phone speaker. Yards that don't have the part stay silent.</li>
        ...
        <section id="who-uses">
          ...
          <p>
            <strong>As buyers:</strong> When a customer calls a yard asking for a specific part the yard doesn't carry,
        ...
        <section id="get-started">
          ...
          <p>
            ...
            desk phone ships to your yard. Plug it in and you're immediately connected to the live room, hearing every
            part request in your region the moment it's broadcast. There's no software to install, no inventory to upload,
...
export function AutoPartsHotlinePage() {
  const FAQS = [
    ...
    { q: "Is a parts hotline better than calling yards individually?", a: "Dramatically. Calling yards one by one, you might reach 5 in an hour, and most go to voicemail. On a parts hotline, one broadcast reaches 97 yards simultaneously. The network has processed 15,000+ requests with a 60% live answer rate and a 2-second average response time. What used to take an hour takes 10 seconds." },
...
export function CarPartAlternativePage() {
  ...
  const FAQS = [
    ...
    { q: "Do I need to list my inventory on Hotline HQ?", a: "No. That's the key difference. On Car-Part.com, you need every part cataloged before a buyer can find it. On Hotline HQ, buyers broadcast what they need and you respond when you have it. No photos, no data entry, no catalog management. This makes Hotline HQ especially valuable for smaller yards that can't maintain a full parts database." },
...
export function SalvageYardMarketingPage() {
  const FAQS = [
    ...
    { q: "How many leads can I expect per day?", a: "Active rooms like California average 40+ broadcasts per day, each one a potential sale. You hear every request in your room. How many you close depends on your inventory and response speed. The average response time is 2 seconds, and first to answer typically wins the deal. Even 1-2 sales per day can change a yard's revenue." },
    ...
    { q: "How is this different from paying for ads?", a: "Google Ads and Facebook Ads drive traffic to your website and hope visitors convert. Hotline HQ gives you buyers who've already described exactly what they need. There's no funnel, no landing page, no conversion rate to improve. You hear 'I need a 2018 Civic bumper,' if you have it, you respond. The 'lead' is already qualified." },
      ...
      <section className="fp-section">
        ...
        <div className="fp-advantages">
          {[
            ...
            { title: "SEO takes months and requires content", copy: "Ranking a salvage yard website on Google means writing blog posts, improving pages, building backlinks, and waiting 6-12 months. Most yard owners don't have time to be content marketers. And even with rankings, you're still waiting for someone to search, find you, and call." },
