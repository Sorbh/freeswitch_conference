...
/* broadcast activity notification stack */
.l2-broadcast-origin { display: flex; align-items: center; gap: 10px; min-width: 0; }
.l2-broadcast-icon {
  display: inline-flex; align-items: center; justify-content: center; flex: 0 0 auto;
  width: 32px; height: 32px; border-radius: 6px; color: var(--red); background: var(--red-soft);
}
.l2-broadcast-origin > div { min-width: 0; display: grid; gap: 2px; }
.l2-broadcast-label {
  display: inline-flex; align-items: center; gap: 6px;
  font-family: var(--mono); font-size: 10px; font-weight: 600;
  letter-spacing: 0.12em; text-transform: uppercase; color: var(--muted);
}
.l2-broadcast-origin strong { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 13.5px; }
.l2-broadcast-room { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--muted); font-size: 11.5px; }
.l2-broadcast-responders { min-width: 0; margin-top: 9px; }
.l2-broadcast-name-list {
  display: grid; grid-template-columns: auto minmax(0, 1fr); align-items: start; gap: 6px;
  max-height: 38px; overflow-y: auto; color: #087443; font-family: var(--mono); font-size: 11px; line-height: 1.45;
}
.l2-broadcast-name-list svg { margin-top: 1px; flex: 0 0 auto; }
.l2-broadcast-name-list span { min-width: 0; }
.l2-broadcast-no-replies { display: inline-block; color: var(--muted); font-size: 11.5px; }
.l2-broadcast-actions { display: flex; align-items: center; justify-content: space-between; gap: 16px; margin-top: 9px; color: var(--muted); font-family: var(--mono); font-size: 11px; white-space: nowrap; }
.l2-broadcast-play {
  display: inline-flex; align-items: center; justify-content: center; width: 30px; height: 30px; padding: 0;
  border-radius: 6px; background: var(--red); color: #fff !important;
  box-shadow: 0 6px 16px -8px rgba(217,45,32,0.7); transition: background .2s, transform .15s;
}
.l2-broadcast-play:hover { background: var(--red-deep); transform: translateY(-1px); }

.l2-broadcast-notices {
  position: fixed; right: 22px; bottom: 22px; z-index: 80;
  display: flex; flex-direction: column; align-items: stretch; gap: 10px;
  width: min(328px, calc(100vw - 32px));
}
.l2-broadcast-latest {
  padding: 10px; border: 1px solid var(--line); border-left: 3px solid var(--red);
  border-radius: 8px; background: rgba(255,255,255,0.98); box-shadow: 0 16px 40px -16px rgba(22,24,29,0.35);
}
.l2-broadcast-latest-head {
  display: flex; align-items: center; justify-content: space-between; gap: 12px; margin-bottom: 8px;
  color: var(--muted); font-family: var(--mono); font-size: 10px; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase;
}
.l2-broadcast-latest-head time { color: #8c908f; font-size: 10px; letter-spacing: 0; text-transform: none; white-space: nowrap; }
.l2-broadcast-notice {
  display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: start; gap: 11px;
  padding: 13px 12px; border: 1px solid var(--line); border-left: 3px solid var(--red);
  border-radius: 8px; background: rgba(255,255,255,0.98); box-shadow: 0 16px 40px -16px rgba(22,24,29,0.35);
  animation: l2-broadcast-notice-in .24s ease-out;
}
@keyframes l2-broadcast-notice-in { from { opacity: 0; transform: translateX(20px); } to { opacity: 1; transform: translateX(0); } }
.l2-broadcast-notice-icon {
...
.l2-broadcast-notice-icon.reply { background: #edf9f1; color: #087443; }
.l2-broadcast-notice-copy { display: flex; min-width: 0; flex-direction: column; gap: 3px; }
.l2-broadcast-notice-copy strong { color: var(--ink); font-size: 13.5px; }
.l2-broadcast-notice-copy span { color: var(--muted); font-size: 12.5px; line-height: 1.4; }
.l2-broadcast-notice-copy a { align-self: flex-start; margin-top: 3px; color: var(--red); font-size: 12px; font-weight: 700; }
.l2-broadcast-notice button { padding: 3px; color: var(--muted); background: transparent; border: 0; cursor: pointer; }
.l2-broadcast-notice button:hover { color: var(--ink); }
