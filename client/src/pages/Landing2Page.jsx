...
export default function Landing2Page() {
  ...
  return (
    <div className="l2" ref={rootRef}>
      ...
      {/* sticky mobile CTA */}
      <div className="l2-sticky-cta">
        <a className="l2-sticky-btn l2-sticky-signup" href={signupUrl}>
          {t("common:nav.signUpFree")}
        </a>
        <a
          className="l2-sticky-btn l2-sticky-help"
          href="https://wa.me/66917636278?text=Hi%2C%20I%20have%20a%20question%20about%20Hotline%20HQ"
          target="_blank"
...
@media (max-width: 860px) {
  #sg-launcher, #sg-badge { display: none !important; }
}
...
.l2-sticky-btn {
  font-family: var(--body); font-weight: 700; font-size: 15px; letter-spacing: 0.02em;
...
.l2-sticky-signup:hover { background: var(--red-deep); }
.l2-sticky-help {
  display: inline-flex; align-items: center; justify-content: center; gap: 6px;
  flex: 0 0 auto; padding: 15px 20px;
  background: #fff; color: var(--ink);
}
.l2-sticky-help:hover { background: #f3f0eb; }
@media (max-width: 860px) { .l2-sticky-cta { display: flex; } }
